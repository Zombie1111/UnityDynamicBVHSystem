//Supposed to be an easy to use API for adding and removing BVH objects and instances, not implemented yet
...
//            isInitilized = true;
//
//            blasObjects = new NativeReusableArray<BLASObject>(maxBlasObjects, Allocator.Persistent);
//        }
//
...
//        private NativeReusableArray<BLASObject> blasObjects;
//
//        public int AddBlasObject(in BLASObject blasO)
//        {
...
//        private NativeReusableArray<BLASInstance> blasInstances;
//
...
//        #region Getting Tlas
//
//        private Dictionary<int, TLASScene> activeTlasScenes = new();
